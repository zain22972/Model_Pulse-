...
export function RemediationApprovalModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-zinc-950/70 backdrop-blur-sm p-4">
      <div className={`w-full max-w-2xl overflow-hidden rounded-xl border bg-zinc-900 shadow-2xl ${risk.border}`}>
        {/* Header */}
            ...
            <>
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  className="w-full rounded-lg bg-zinc-950 border border-zinc-700 text-zinc-200 p-3 font-mono text-sm resize-none focus:outline-none focus:ring-1 focus:ring-blue-500"
                  rows={3}
                />
              </div>
              ...
              <div className="flex items-center justify-between bg-zinc-950/30 border border-zinc-800/50 rounded-lg p-3">
                <div className="flex flex-col items-center">
                  ...
                  <div className="w-24 h-12 bg-red-900/20 border border-red-800/50 rounded flex items-end">
                     <div className="w-full h-8 bg-red-500/20" style={{ clipPath: 'polygon(0 80%, 20% 80%, 40% 20%, 60% 0, 80% 20%, 100% 80%, 100% 100%, 0 100%)' }}></div>
                  </div>
                </div>
                ...
                <div className="flex flex-col items-center">
                  ...
                  <div className="w-24 h-12 bg-emerald-900/20 border border-emerald-800/50 rounded flex items-end">
                     <div className="w-full h-8 bg-emerald-500/20" style={{ clipPath: 'polygon(0 80%, 20% 80%, 40% 70%, 60% 80%, 80% 70%, 100% 80%, 100% 100%, 0 100%)' }}></div>
                  </div>
                </div>
              </div>
